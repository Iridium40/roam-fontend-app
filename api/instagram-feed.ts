    ...
    if (!accessToken) {
      ...
      const mockData = [
        ...
        },
        {
          id: '4',
          media_type: 'IMAGE' as const,
          media_url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=400&fit=crop',
          caption: 'Home organization made easy! Our lifestyle experts can help ✨ #ROAMLifestyle #OrganizedHome #roam_yourbestlife',
          timestamp: new Date().toISOString(),
          permalink: 'https://www.instagram.com/roam_yourbestlife/',
          likes: 203,
          comments: 24
