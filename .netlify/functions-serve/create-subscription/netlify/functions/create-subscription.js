...
var require_apiVersion = __commonJS({
  "netlify/functions/node_modules/stripe/cjs/apiVersion.js"(exports2) {
    ...
    exports2.ApiVersion = "2025-07-30.basil";
    exports2.ApiMajorVersion = "basil";
  }
});
...
var create_subscription_exports = {};
__export(create_subscription_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(create_subscription_exports);
var handler = async (event, context) => {
  ...
  try {
    ...
    const stripe = require_stripe_cjs_node()(process.env.STRIPE_SECRET_KEY);
    const priceIds = {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      // This should be the customer's email
