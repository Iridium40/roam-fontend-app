...
export default function Providers() {
  const benefits = [
    ...
    },
    {
      ...
      description: "Work when you want, where you want. Set your own availability and rates.",
      highlight: "100% control"
    },
    {
      icon: Users,
      title: "Quality Clients",
      description: "Connect with verified customers who value premium services.",
      highlight: "Pre-screened customers"
    },
    {
      icon: Shield,
      title: "Full Support",
      description: "Comprehensive insurance coverage, background verification, and 24/7 support.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-roam-light-blue/10">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-foreground/70 mb-8 max-w-2xl mx-auto leading-relaxed">
              Join Florida's premier network of service professionals. Connect with quality clients, set your own rates, and build your business with the support you deserve.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-sm text-foreground/60">Average annual earnings</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-roam-blue">4.9/5</div>
                <div className="text-sm text-foreground/60">Provider satisfaction</div>
              </div>
              <div className="text-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
              We're more than a platform – we're your business partner, dedicated to your success and growth.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              <span className="text-roam-blue">Earning Potential</span> by Service
            </h2>
            <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                  ...
                  {earnings.map((earning, index) => (
                    <div key={index} className="flex items-center justify-between p-4 rounded-lg bg-accent/20 hover:bg-accent/30 transition-colors">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-foreground/60">Per hour, before taxes</div>
                      </div>
                      <div className="text-center mx-4">
                        <div className="text-lg font-bold text-roam-blue">{earning.range}</div>
                      </div>
                      <div className="text-right">
                        <Badge 
                          variant={earning.demand === 'Very High' ? 'default' : 'secondary'}
                          className={earning.demand === 'Very High' ? 'bg-roam-success text-white' : ''}
                        >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-foreground/70">
                We maintain high standards to ensure the best experience for both providers and customers.
              </p>
            </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="mt-8 p-6 bg-roam-light-blue/10 rounded-lg border border-roam-light-blue/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-roam-blue mb-2">Verification Process</h4>
                      <p className="text-sm text-foreground/70">
                        All providers undergo comprehensive background checks, identity verification, and skill assessment. 
                        We also provide ongoing training and certification opportunities to help you grow.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-roam-blue to-roam-light-blue">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join hundreds of successful providers who've grown their business with ROAM. Application takes less than 10 minutes.
          </p>
