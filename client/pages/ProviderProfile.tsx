...
export default function ProviderProfile() {
  ...
  const provider = {
    ...
    specialties: ["Deep Tissue", "Swedish", "Sports Massage", "Prenatal", "Hot Stone"],
  ...
  const services = [
    {
      ...
      duration: "90 minutes",
      price: 120,
      description: "Therapeutic massage targeting deeper layers of muscle and connective tissue to relieve chronic pain and tension.",
      deliveryTypes: ["mobile", "business"],
    ...
    },
    {
      ...
      duration: "60 minutes",
      price: 90,
      description: "Relaxing full-body massage using long strokes, kneading, and circular movements to promote relaxation.",
      deliveryTypes: ["mobile", "business"],
      popularity: null
    },
    {
      ...
      duration: "75 minutes",
      price: 110,
      description: "Specialized massage for athletes focusing on injury prevention and recovery enhancement.",
    ...
    },
    {
      ...
      duration: "60 minutes",
      price: 100,
      description: "Gentle, safe massage designed specifically for expecting mothers to reduce pregnancy discomfort.",
      deliveryTypes: ["mobile", "business"],
      popularity: null
    }
  ];
  ...
  const reviews = [
    {
      ...
      review: "Sarah is absolutely amazing! She relieved all the tension in my shoulders and back. Very professional and skilled. Will definitely book again!",
      verified: true
    },
    {
      id: 2,
      ...
      review: "Perfect for post-workout recovery. Sarah knows exactly how to target problem areas. Great communication and very punctual.",
      verified: true
    },
    {
      id: 3,
      ...
      review: "So relaxing! Sarah created the perfect ambiance and her technique is excellent. Love that she comes to my home.",
      verified: true
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-700 leading-relaxed mb-6">{provider.bio}</p>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {provider.specialties.map((specialty) => (
                          <Badge key={specialty} variant="outline" className="border-roam-blue text-roam-blue">
                            {specialty}
                          </Badge>
                        ))}
                      </div>
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              <div className="flex">
                                {[...Array(review.rating)].map((_, i) => (
                                  <Star key={i} className="w-4 h-4 text-roam-warning fill-current" />
                                ))}
                              </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{provider.responseRate}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <span className="text-gray-600 block mb-1">Service Area</span>
                    <span className="font-semibold">{provider.serviceArea}</span>
                  </div>
                  <div>
                    <span className="text-gray-600 block mb-1">Studio Location</span>
                    <span className="font-semibold">{provider.businessAddress}</span>
                  </div>
                  <div>
                    <span className="text-gray-600 block mb-2">Available Days</span>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full border-roam-blue text-roam-blue hover:bg-roam-blue hover:text-white">
