...
const blogPosts: BlogPost[] = [
  {
    id: '1',
    title: 'Mobile IV Therapy Services: Discover Convenience on the Emerald Coast with ROAM',
    excerpt: 'Explore the benefits of mobile IV therapy and how ROAM brings professional wellness services directly to your location.',
  ...
  },
  {
    ...
    excerpt: 'Recap of our community wellness event bringing together local providers and health-conscious individuals.',
    category: 'COMMUNITY',
  ...
  },
  {
    ...
    excerpt: 'Discover the confidence-boosting benefits of professional spray tanning and why mobile services are the future.',
    category: 'BEAUTY SPRAY TAN',
    image: 'https://cdn.builder.io/api/v1/image/assets%2Fa42b6f9ec53e4654a92af75aad56d14f%2Fc812f66efc8641e5a5e8b82ad8a50e3e?format=webp&width=800',
  ...
  {
    id: '4',
    title: 'Glow On The Go: Why Mobile Spray Tanning Is the Ultimate Beauty Hack',
    excerpt: 'Learn why mobile spray tanning services are revolutionizing the beauty industry and how to achieve the perfect glow.',
    category: 'BEAUTY SPRAY TAN',
  ...
  },
  {
    ...
    excerpt: 'How community infrastructure improvements are making wellness services more accessible in coastal communities.',
    category: 'COMMUNITY',
  ...
  },
  {
    ...
    excerpt: 'The importance of regular massage therapy for mental and physical health, now available in your home.',
  ...
  },
  {
    ...
    excerpt: 'Research-backed benefits of in-home personal training and how it compares to traditional gym workouts.',
    category: 'FITNESS',
  ...
  },
  {
    ...
    excerpt: 'How mobile wellness services are transforming healthcare delivery and improving patient outcomes.',
    category: 'WELLNESS',
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <Link to="/home" className="text-foreground/80 hover:text-roam-blue transition-colors">
                Services
              </Link>
              <Link to="/providers" className="text-foreground/80 hover:text-roam-blue transition-colors">
                Providers
              </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-foreground/70 mb-8 max-w-2xl mx-auto">
              Insights, tips, and stories from the world of mobile wellness and beauty services
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-8 text-white/90">
              Get the latest wellness tips and ROAM updates delivered to your inbox
            </p>
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <Button variant="secondary" className="bg-white text-roam-blue hover:bg-gray-100">
                Subscribe
              </Button>
            </div>
          </div>
