            ...
            <Card className="border-border/50">
              <CardContent className="p-12">
                ...
                <p className="text-lg text-foreground/70 mb-8">
                  ...
                  but don't worry – we'll help you find your way back to amazing services.
                </p>
                
                <div className="bg-roam-light-blue/10 rounded-lg p-6 mb-8 border border-roam-light-blue/20">
                  <p className="text-sm text-foreground/80">
                    💡 <strong>Quick Suggestions:</strong> Try visiting our homepage to explore services, 
                    or use the navigation menu to find what you need. Our premium providers are ready to serve you!
                  </p>
                </div>
                ...
                <div className="mt-8 text-sm text-foreground/60">
                  <p>Need help? <Link to="/support" className="text-roam-blue hover:underline">Contact our support team</Link></p>
                </div>
              </CardContent>
            </Card>
          </div>
