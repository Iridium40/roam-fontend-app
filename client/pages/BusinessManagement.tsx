...
import type { BusinessProfile, BusinessLocation, Provider } from "@/lib/database.types";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-roam-light-blue/10 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-foreground/70 mb-4">Unable to load business information.</p>
          <Button asChild>
      ...
      <nav className="border-b bg-background/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Button onClick={saveBusiness} disabled={saving} className="bg-roam-blue hover:bg-roam-blue/90">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="details" className="space-y-6">
          <TabsList className="grid w-full grid-cols-5">
            <TabsTrigger value="details" className="data-[state=active]:bg-roam-blue data-[state=active]:text-white">
              Business Details
            </TabsTrigger>
            <TabsTrigger value="locations" className="data-[state=active]:bg-roam-blue data-[state=active]:text-white">
              Locations
            </TabsTrigger>
            <TabsTrigger value="services" className="data-[state=active]:bg-roam-blue data-[state=active]:text-white">
              Services & Pricing
            </TabsTrigger>
            <TabsTrigger value="team" className="data-[state=active]:bg-roam-blue data-[state=active]:text-white">
              Team Management
            </TabsTrigger>
            <TabsTrigger value="hours" className="data-[state=active]:bg-roam-blue data-[state=active]:text-white">
              Business Hours
            </TabsTrigger>
          </TabsList>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge className={
                        ...
                        {business.verification_status === 'approved' && <CheckCircle className="w-3 h-3 mr-1" />}
                        {business.verification_status}
                      </Badge>
                      {business.verification_status === 'approved' && (
                        <span className="text-sm text-green-600">Your business is verified</span>
                      )}
                    </div>
                  </div>
                </CardContent>
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        {location.is_primary && (
                          <Badge className="bg-roam-blue text-white mt-1">Primary</Badge>
                        )}
                      </div>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {location.offers_mobile_services && (
                      <div className="flex items-center gap-2 text-sm text-roam-blue">
                        ...
                        Mobile services: {location.mobile_service_radius} mile radius
                      </div>
                    )}
                    
                    <div className="flex gap-2">
                      <Button size="sm" variant="outline" className="flex-1 border-roam-blue text-roam-blue hover:bg-roam-blue hover:text-white">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { name: 'Deep Tissue Massage', price: 120, duration: '90 min', active: true, delivery: ['mobile', 'in_person'] },
                    { name: 'Swedish Massage', price: 90, duration: '60 min', active: true, delivery: ['mobile', 'in_person'] },
                    { name: 'Sports Recovery Massage', price: 110, duration: '75 min', active: false, delivery: ['mobile'] },
                    { name: 'Prenatal Massage', price: 100, duration: '60 min', active: true, delivery: ['in_person'] }
                  ].map((service, index) => (
                    <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <p className="font-semibold text-roam-blue">${service.price}</p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-foreground/60 capitalize">{member.provider_role}</p>
                        ...
                        <div className="mt-3 flex items-center gap-2">
                          ...
                          {member.average_rating > 0 && (
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-xs">{member.average_rating}</span>
                            </div>
                          )}
                        </div>
